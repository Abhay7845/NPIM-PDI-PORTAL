...
const NewFeedbackL1AndL2 = () => {
  ...
  const GetProductDetailsPnpim = (productDetails) => {
    APIPNPIMProductData(
      `api/NPIM/l1l2/npim/get/product/details/l1l2`,
      productDetails
    )
      .then((response) => {
        console.log("response==>", response.data);
  ...
  const onClickNextPreBtnHandler = (productDetails, direction) => {
    console.log("productDetails==>", productDetails);
    setLoading(true);
    const Input = {
      storeCode: storeCode,
    ...
    APIGetPreNextProductData(
      `api/NPIM/l1l2/new/npim/get/product/details/PreNex`,
      Input
    )
      .then((res) => res)
      .then((response) => {
        ...
        .then((response) => {
          ...
          if (response.data.code === "1000") {
            if (sessionStorage.getItem("Npim-type") === "DNPIM") {
              ...
              setTimeout(() => {
                onClickNextPreBtnHandler(feedShowState, "pre");
              }, 1000);
            }
            if (sessionStorage.getItem("Npim-type") === "PNPIM") {
              setAlertPopupStatus({
          ...
          <div className="row mx-0">
            ...
            <div
              ...
              style={{
                margin: "0%",
                padding: "3px",
                boxShadow: "0 2px 4px 0 #00000033, 0 6px 20px 0 #00000030",
              }}
            >
                ...
                <div className="col-md-7">
                  ...
                  <div style={{ border: "1px solid gray", padding: "5px" }}>
                    ...
                    <div className="mt-2">
                      ...
                      >
                        How would you rate this product in terms of look to
                        price?
                      </h6>
                      <div className="d-flex justify-content-center">
                        <Rating
                    ...
                    <div className="mt-2">
                      ...
                      >
                        ...
                        differentiation fit for Tanishq brand?
                      </h6>
                      <div className="d-flex justify-content-center">
                        <Rating
                          name="simple-controlled"
              ...
              <div className="d-flex mt-2 justify-contetn-between with-100">
                ...
                {sessionStorage.getItem("Npim-type") === "DNPIM" && (
                  <Button
                    className={classes.btn}
                    onClick={() =>
                      onClickNextPreBtnHandler(feedShowState, "next")
                    }
