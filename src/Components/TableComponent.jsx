            ...
            <TableRow>
              {props.coloum.map((column, index) => (
                <TableCell
                  ...
                  align="center"
                  className={
                    column === "Action" ? "bg-secondary" : classes.tableCell
                  }
                >
                  {column.toUpperCase()}
                </TableCell>
            ...
            {props.report
              ...
              .map((row, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell align="center">{row.quality_Rating}</TableCell>
                  <TableCell align="center">{row.quality_Reasons}</TableCell>
                </TableRow>
              ))}
          </TableBody>
        </Table>
