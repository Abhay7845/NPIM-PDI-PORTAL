...
export default function DisplayValidationComponent(props) {
  ...
  const set2tag =
    digit === "0" || digit === "1" || digit === "2"
      ? ""
      : feedShowState.childNodesN && feedShowState.childNodesE && "Set2Tag";
  const set2Tag_H =
    digit === "0" || digit === "1" || digit === "2"
      ? ""
      : feedShowState.childNodeH && feedShowState.childNodesE && "Set2Tag_H";
  ...
  useEffect(() => {
    APICoupleBandDropdown(
      `/NPIML3/npim/L3/dropdown/couple/band/${itemCode}/COUPLE%20GENTS`
    )
      .then((res) => res)
      .then((result) => {
  ...
  useEffect(() => {
    APICoupleBandDropdown(
      `/NPIML3/npim/L3/dropdown/couple/band/${itemCode}/COUPLE%20LADIES`
    )
      .then((res) => res)
      .then((result) => {
  ...
  return (
    <React.Fragment>
      ...
      digit === "K" ? (
        <React.Fragment>
          ...
          {feedShowState.findings && (
            <DropDownMaterialUI
              labelName={
                feedShowState.category.toUpperCase() === "CHAINS"
                  ? "Hooks Type"
                  : "Findings"
              }
      ...
      {digit === "N" &&
        (feedShowState.activity.toUpperCase() === "STUDDED" ||
        feedShowState.activity === "" ? (
          ""
        ) : (
          <DropDownMaterialUI
