...
const GetProductsHome = () => {
  ...
  return (
    <div style={{ backgroundColor: "#f0ebec", height: "100vh" }}>
      ...
      />
      {homePdtDetailsAdvariant.length > 0 || homePdtDetailsRegion.length > 0 ? (
        <div className="mt-2" style={{ backgroundColor: "#f0ebec" }}>
          <div className="mx-3 p-3">
            <h5 className="Heading_text my-4">
              <b>ADVARIANTS!</b>
            </h5>
            <ImageCrousel
              advariantDetails={
                homePdtDetailsAdvariant.length > 0 && homePdtDetailsAdvariant
              }
              statusData={statusData}
              cardStuddData={cardStuddData}
              cardPlainData={cardPlainData}
            />
          </div>
          {homePdtDetailsRegion.length > 0 && (
            <div className="product_carousel">
              <h5 className="Heading_text mt-5">
                <b>REGIONAL COLLECTION</b>
              </h5>
                ...
                {homePdtDetailsRegion.map((item, i) => {
                  return (
                    <ProductCard
                      key={i}
                      cardDetails={item}
                      AlertPopup={setAlertPopupStatus}
                      PdtCardData={GetHomeProductsDataForRegion}
                    />
                  );
                })}
              </div>
                ...
                <div className="col-md-6">
                  <div className="card border-secondary">
                    ...
                    <div className="text-center p-2">
                      <b>
                        {SeprateCard.totalSKU === "N/A"
                          ? 0
                          : SeprateCard.totalSKU}
                      </b>
                    </div>
                  </div>
                </div>
