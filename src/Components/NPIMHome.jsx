        ...
        {portalDetail.map((data, i) => {
          return (
            data.status === "OPEN" && (
              <div
                key={i}
                className="NpimRedirectionTab"
                onClick={() => {
                  if (
                    data.portalType === "PNPIM" ||
                    data.portalType === "DNPIM" ||
                    data.portalType === "IndentExpress" ||
                    data.portalType === "MIA-PostNPIMPortal"
                  ) {
                    setOpen(true);
              ...
              >
                {data.portalType === "PNPIM"
                  ...
                  : data.portalType === "IndentExpress"
                  ? "INDENT EXPRESS"
                  : data.portalType === "MIA-PostNPIMPortal" && "MIA FEEDBACK"}
              </div>
            )
          );
        })}
